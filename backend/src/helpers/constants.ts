...
export const SHEET_HEADERS: Record<string, string[]> = {
  [SHEET_NAMES.TASKS]: ['id', 'name', 'description', 'box', 'goal_id', 'context_id', 'category_id', 'is_completed', 'completed_at', 'repeat_rule', 'is_hidden', 'next_date', 'appear_date', 'original_task_id', 'sort_order', 'is_deleted', 'created_at', 'updated_at', 'version', 'revision'],
