# Goals Capability Spec

## Purpose

Manage personal goals using GTD methodology. Goals serve as containers that group tasks, track progress through statuses, and support visual identification via covers.
