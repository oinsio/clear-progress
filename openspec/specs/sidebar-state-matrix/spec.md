# Capability: Sidebar State Matrix

## Purpose

Defines the pure function that resolves the effective sidebar state from three independent inputs: screen width, hover capability, and user setting. Also covers hover capability detection, resize behavior, and drawer lifecycle during resize.
