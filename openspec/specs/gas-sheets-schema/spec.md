# Capability: GAS Sheets Schema

## Purpose

Google Sheets data layer for the GAS backend: sheet structure definitions, column mappings, type coercion utilities (booleans, timestamps, dates, enums), CRUD operations on sheet rows, and meta/revision management.
