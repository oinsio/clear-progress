...
Unified command bar component for entity creation across all pages. Provides configurable layout with optional filter, eye toggle, textarea with entity icon, and create button. Supports handedness mirroring, auto-growing textarea, and responsive behavior within the content area.
