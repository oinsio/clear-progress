...
This spec covers the deleted entities (trash) capability: aggregation of soft-deleted entities across all entity types, restore operations, empty/loading states, reactive updates, and parent task context for checklist items.
...
#### Scenario: Loading state before subscriptions complete
...
#### Scenario: New deletion appears in real-time
...
#### Scenario: Restored entity disappears in real-time
...
#### Scenario: Checklist item displays parent task name
