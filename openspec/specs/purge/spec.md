...
This spec covers server-side purge behavior: permanent (hard) deletion of all soft-deleted records across all entity types, confirmation requirements, response format, revision tracking, and error handling.
