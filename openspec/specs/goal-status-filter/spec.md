# Capability: Goal Status Filter

## Purpose

Provides status-based filtering for the Goals page, allowing users to view goals by activity state (active, paused, finished) or all goals at once. Filter selection persists across sessions via localStorage.
