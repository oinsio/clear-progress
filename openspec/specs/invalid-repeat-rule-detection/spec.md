# Capability: Invalid Repeat Rule Detection

## Purpose

Detects and surfaces invalid repeat rules in tasks — both on completion and after pull sync. Provides visual warnings in the task detail panel and alerts via AlertProvider when invalid rules are encountered.
