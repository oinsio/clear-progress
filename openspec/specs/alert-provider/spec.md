# Capability: Alert Provider

## Purpose

Centralized alert system providing a typed alert queue with paginated overlay navigation. Supports multiple alert types (sync, repeat_rule_invalid) with type-based priority ordering and accessible dialog rendering.
