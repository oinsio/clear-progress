# Capability: GAS Server

## Purpose

Google Apps Script server-side web app handling HTTP requests, authentication via Google tokeninfo API, owner email auto-registration, action routing, and standardized error/success response formatting.
