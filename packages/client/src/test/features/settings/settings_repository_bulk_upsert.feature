Feature: Settings repository bulk upsert
  ...
  Scenario: Accept newer server setting
    Given a local setting with key "accent_color", value "green", updated_at "2025-01-01T00:00:00.000Z", and syncStatus "synced"
    ...
    And the setting has syncStatus "synced"

  @settings-specs-and-bdd @FR3 @FR6
  Scenario: Skip server setting when local is dirty
    Given a local setting with key "accent_color", value "coral", and syncStatus "pending"
