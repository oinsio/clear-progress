...
import type { Goal, Setting, Task } from "../types";
...
describe("push", () => {
  ...
  describe("rejected record (blank name/name)", () => {
    ...
    it("should return status: rejected for context with empty name", () => {
      const blankContext = makeContext({
    ...
    it("should return status: rejected for category with empty name", () => {
      const blankCategory = makeCategory({
    ...
    it("should return status: rejected for checklist_item with empty name", () => {
      const blankItem = makeChecklistItem({
